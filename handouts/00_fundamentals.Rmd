...
The previous paragraph might lead you to ponder why R is in use today and why the popularity is growing.
...
There are currently more than eleven thousand extensions (refered to as packages) to R in the core ecosystem ([CRAN](https://www.r-project.org/)) and two and a half thousand packages in the genomics ecosystem ([BioConductor](https://www.bioconductor.org/)). 

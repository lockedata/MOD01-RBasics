...
## Dates
```{block, type="future"}
Dates are one of the hardest parts of programming! This is a very brief introduction and will not be covered further in this book. Expect a book entirely dedicated to date handling later.
```

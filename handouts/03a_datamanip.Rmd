...
In vectors and lists, you can specify the element position as they only have a single dimension. In data.frames, you can pinpoint both the element (row) and the column.
...
## Changing objects
By utilising our reference systems, not only we can select data of interest to us, but we can add new data, update existing values, and even delete values.
